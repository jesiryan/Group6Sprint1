	...
	<body>
		<div id='container'>
			<div id='heading-container'>
				...
				<h4>User Story 4</h4>
				<h4> As Customer Service Rep. I want to display, for a given affected IMSI, 
				<br>the Event ID and Cause Code for any / all failures affecting that IMSI</h4>
			</div>
            <div id='inner-container' >                
				<form method=GET action='imsiQuery'>
					<input type='hidden' name='userStoryNumber' value='us4'>
					<input class='submissionfield' type='text' name='imsi' placeholder='Please Enter an IMSI number Here' required='required'>
					<input type='submit'>
